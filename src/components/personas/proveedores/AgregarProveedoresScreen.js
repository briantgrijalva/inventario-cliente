...
import { addNewProveedor } from '../../../actions/personas';
import { useForm } from '../../../hooks/useForm';
// import '../../styles/SucursalesScreen.css';

export const AgregarProveedoresScreen = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(addNewProveedor(nombres, apellidos, tel, email, tipoCuenta, pass, pass2));
        // TODO: mostrar alerta
        reset();
        //navigate('/personas');
    }
